...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "edu1.degree": "Licenciatura en Informática (Incompleta)",
    ...
    "footer.design": "Diseñado con Tailwind CSS.",
  },
  en: {
    "page.title":
    ...
    "edu1.degree": "B.S. in Information Science (Incomplete)",
    "edu1.institution": "Instituto Leonardo Bravo",
    "edu1.date": "2011 – 2015",
    ...
    "footer.design": "Designed with Tailwind CSS.",
  },
};
